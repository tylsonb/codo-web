...
Flickity.create.fullscreen = function() {
  ...
  // buttons
  const viewFullscreenButton = new FullscreenButton( 'view', this );
  const exitFullscreenButton = new FullscreenButton( 'exit', this );

  this.viewFullscreenButton = viewFullscreenButton;
